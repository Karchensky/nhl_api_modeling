##############################################################################
#plotting elements for the rink proper.  I most certainly stole this image generator from the internet & will credit when I stumble across it again
...
png("D:/Scripts/Modeling/nhl_api/nhl_api_modeling/ice_rink.png", width=860, height=2050)
full.rink()
dev.off()